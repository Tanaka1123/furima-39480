class OrderAddress
 ...
 with_options presence: true do
  ...
  def save
    ...
    ShippingAddress.create(postal_code: postal_code, prefecture: prefecture, city: city, addresses: addresses, building: building, phone_number: phone_number, order: order.id)
  end
end
