class OrderAddress
  ...
  with_options presence: true do
    ...
    validates :phone_number, presence: { message: "can't be blank" }, length: { minimum: 10, message: 'is too short' },
                             numericality: { only_integer: true, message: 'is invalid. Input only numbers' }
  end
